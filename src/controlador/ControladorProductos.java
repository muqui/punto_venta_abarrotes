...
public class ControladorProductos implements ActionListener {
    ...
    public ControladorProductos(Principal vistaPrincipal, JpanelProductos jpanelProductos, JpanelProductoNuevo jpanelProductoNuevo, JpanelContenidoPaquete jpanelContenidoPaquete) {
        ...
        // jpanelContenidoPaquete.jPanelContenidoPaquete.setVisible(false);
        clearErrorLabel();
...
//        if (jpanelProductoNuevo.jComboBoxComoSevende.getSelectedIndex() == 2) {
//            System.out.println("SELECCIONAR PAQUETE MQ12 X");
//            jpanelProductoNuevo.jComboBoxDepartamento.addItem("Paquete");
//        } else {
//            try {
//                
...
//                    // System.out.println("" + departamentos.get(i).getNombre() + " id " + departamentos.get(i).getId());
